require("olisander.globals")

require("olisander.options")

require("olisander.netrw")

require("olisander.keymap")

require("olisander.autocommands")
...
require("lazy").setup({
		...
		config = function()
			...
			vim.api.nvim_create_autocmd("LspAttach", {
				...
				callback = function(event)
					...
					-- Add round borders to hover doc
		...
		config = function()
			require("conform").setup({
				...
				formatters_by_ft = {
					...
					php = { "docker_phpcbf", "trim_whitespace" },
				},
				formatters = {
					docker_phpcbf = {
						command = "docker",
						args = function(self, ctx)
							local args = {
								...
								"vendor/bin/phpcbf",
								"/app/core" .. ctx.filename:sub(#self.cwd(self, ctx) + 1),
							}
							return args
						end,
						stdin = false,
	...
	require("olisander.plugins.undotree"),

	-- require("olisander.plugins.null-ls"),
	require("olisander.plugins.debug"),
	require("olisander.plugins.harpoon"),
	require("olisander.plugins.autotag"),
